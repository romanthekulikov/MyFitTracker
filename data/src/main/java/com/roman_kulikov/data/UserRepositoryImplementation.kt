...
class UserRepositoryImplementation @Inject constructor(val firebaseAuth: FirebaseAuth) : UserRepository {
    @Inject lateinit var catcher: Catcher

    override suspend fun auth(email: String, password: String): Either<String, Boolean> {
    ...
    override suspend fun register(email: String, password: String): Either<String, Boolean> {
        return catcher.lunchWithCatch {
